classdef ardurover_MPC_RealVehicleROS < CtSystem
    ...
    methods
        ...
        function xDot = f(obj,t,x,u,varargin)
            ...
            obj.target_angle = 90 - obj.target_angle;
            ...
            xDot = [obj.vm*cos(x(10));  %Velocity of Attacker in x-dircetion
                    ...
                    obj.vt*cos(deg2rad(obj.target_angle));  %Velocity of Target in x-dircetion
                    obj.vt*sin(deg2rad(obj.target_angle));  %Velocity of Target in y-dircetion
                    obj.vt*cos(deg2rad(obj.target_angle)-x(9))-obj.vm*cos(x(10)-x(9));  %Velocity along Attacker-Target LOS
                    (obj.vt*sin(deg2rad(obj.target_angle)-x(9))-obj.vm*sin(x(10)-x(9)))/x(8);   %Angular velocity of above equation
%                     ((((-1).^floor(ceil(t/obj.switchGuidanceLaw)))+1)/2)*(obj.N*((obj.vt*sin(target_angle.Data-x(9))-obj.vm*sin(x(10)-x(9)))/x(8)))+(1-((((-1).^floor(ceil(t/obj.switchGuidanceLaw)))+1)/2))*(((-obj.K*(x(10)-x(9)))/obj.vm))];  %Angular Velocity of Target
                    obj.N*((obj.vt*sin(deg2rad(obj.target_angle)-x(9))-obj.vm*sin(x(10)-x(9)))/x(8))];
                    
            obj.attacker_angular_velocity = obj.N*((obj.vt*sin(deg2rad(obj.target_angle)-x(9))-obj.vm*sin(x(10)-x(9)))/x(8));
