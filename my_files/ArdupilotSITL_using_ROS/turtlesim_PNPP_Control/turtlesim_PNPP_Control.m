...
sys.controller = turtlesim_IController(@(t,x) ((((-1).^floor(ceil(t/obj.switchGuidanceLaw)))+1)/2)*(obj.N*(-obj.vm*sin(x(5)-x(4)))/x(3)))+(1-((((-1).^floor(ceil(t/obj.switchGuidanceLaw)))+1)/2))*(((-obj.K*(x(5)-x(4)))/obj.vm));
